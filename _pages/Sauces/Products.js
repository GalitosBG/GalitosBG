            ...
            >
              <div className={``}>
                <img
                  src={product.image}
                  alt={product.name}
                  className={`object-contain rounded-md transition-all duration-300 hover:scale-105`}
                />
              </div>
              <h1 id={product?.id} className={`text-xl text-center uppercase mt-4 font-medium`}>
                {product.name}
              </h1>
            </div>
          );
